...
<head>
  ...
  <title>Meu QR • <?php echo e(config('app.name')); ?></title>
...
<div class="wrap">
  <div class="card">
    ...
    <div class="title"><?php echo e($user->name); ?></div>
    <div class="code"><?php echo e($qrCode); ?></div>
...
<?php /**PATH C:\Users\Maia\Projetos\Suporte_Champion\suporte-champion\resources\views/profile/qr.blade.php ENDPATH**/ ?>