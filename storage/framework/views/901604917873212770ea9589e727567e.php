...
<div class="mt-6 rounded-3xl shadow-soft bg-gradient-to-br from-brand-50 via-white to-sky-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 p-8 md:p-10">
  <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
      <a href="<?php echo e(route('admin.supports.index')); ?>"
      ...
      <a href="<?php echo e(route('admin.sectors.index')); ?>"
         class="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition">
      ...
      <a href="<?php echo e(route('admin.sectors.create')); ?>"
...
<div class="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
  <a href="<?php echo e(route('admin.posts.create')); ?>" class="group rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5 hover:shadow transition" aria-label="Criar novo Post">
  ...
  <a href="<?php echo e(route('admin.faqs.create')); ?>" class="group rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5 hover:shadow transition" aria-label="Criar nova FAQ">
    <div class="flex items-center gap-3">
  ...
  <a href="<?php echo e(route('admin.events.create')); ?>" class="group rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5 hover:shadow transition" aria-label="Criar novo Evento">
    <div class="flex items-center gap-3">
  ...
  <a href="<?php echo e(route('admin.supports.index')); ?>" class="group rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5 hover:shadow transition" aria-label="Ir para Chamados">
    <div class="flex items-center gap-3">
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mt-6">
  ...
  <div class="rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5">
    ...
    <div class="mt-4">
      <div class="text-3xl font-semibold text-slate-900 dark:text-white"><?php echo e($metrics['users_count']); ?></div>
  ...
  <div class="rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5">
    ...
    <div class="mt-4">
      <div class="text-3xl font-semibold text-slate-900 dark:text-white"><?php echo e($metrics['posts_count']); ?></div>
  ...
  <div class="rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5">
    ...
    <div class="mt-4">
      <div class="text-3xl font-semibold text-slate-900 dark:text-white"><?php echo e($metrics['faqs_count']); ?></div>
  ...
  <div class="rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-5">
    ...
    <div class="mt-4">
      <div class="text-3xl font-semibold text-slate-900 dark:text-white"><?php echo e($metrics['tickets_count']); ?></div>
...
<div class="mt-6 rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 p-6">
  <div class="flex items-center justify-between mb-4">
    ...
    <a href="<?php echo e(route('dashboard.admin.index')); ?>" class="text-sm text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 inline-flex items-center gap-1">
...
<div class="mt-6 rounded-2xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10">
  ...
  <div class="divide-y divide-slate-100 dark:divide-white/10">
    <?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <a href="<?php echo e($row->url); ?>" class="flex items-center justify-between px-6 py-3 hover:bg-slate-50 dark:hover:bg-white/5 transition">
        <div class="flex items-center gap-3">
          <?php switch($row->type):
            case ('post'): ?>
          ...
          <?php endswitch; ?>
          <div>
            <div class="text-sm font-medium text-slate-800 dark:text-slate-100 line-clamp-1"><?php echo e($row->title); ?></div>
            <div class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(\Carbon\Carbon::parse($row->at)->diffForHumans()); ?></div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Maia\Projetos\Suporte_Champion\suporte-champion\resources\views/dashboard/admin/index.blade.php ENDPATH**/ ?>